...
\tag{MATLAB}  
\tag{YAML}  
\tag{Prompt Engineering}  
}\\  

\vspace{1em}  

\textbf{Data Analysis \& Visualization Tools} & \normalsize{  
\tag{Tableau}  
\tag{Power BI}  
\tag{Snowflake}  
\tag{Zenlytic}  
...
\textbf{Automation \& Workflow Tools} & \normalsize{  
\tag{Power Automate}  
\tag{SharePoint}  
\tag{AWS Lambda}  
\tag{Azure CloudShell}  
...
\textbf{Collaboration \& Management Tools} & \normalsize{  
\tag{Jira}  
\tag{Miro}  
\tag{Figma}  
\tag{Microsoft Office}  
