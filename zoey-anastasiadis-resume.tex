...
\multicolumn{2}{@{}X@{}}{
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[label=\textbullet, nosep, leftmargin=2em, itemsep=3pt]
    % \begin{itemize}[label=\textbullet] % Default
    % \begin{itemize}[label=\textendash] % Dash
    % \begin{itemize}[label=\textasteriskcentered] % Asterisk
    % \begin{itemize}[label=\textopenbullet] % Open circle
...
\multicolumn{2}{@{}X@{}}{
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[label=\textendash, nosep, leftmargin=2em, itemsep=3pt]
...
\multicolumn{2}{@{}X@{}}{
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[label=\textasteriskcentered, nosep, leftmargin=2em, itemsep=3pt]
...
\multicolumn{2}{@{}X@{}}{
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[label=\textopenbullet, nosep, leftmargin=2em, itemsep=3pt]
...
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
        \item Facilitate research-related communications for the Associate Dean of Research through various channels
        \item Gather, analyze, and interpret research-related data, and prepare Excel reports for effective decision-making
        \item Update websites using WordPress and maintain high-quality online resources through regular quality assurance checks
        \item Execute research-related events and projects and configure video conferencing for meetings and presentations
    \end{itemize}
    \end{minipage}
}\
\end{tabularx}
...
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
        \item Coordinate and manage 9 training sessions for 450+ IT employees, utilizing Excel to monitor enrollment and attendance
        \item Produce engaging explainer videos using Powtoon for each IT role to facilitate employee onboarding and training
        \item Design Mentimeter questionnaires for training sessions and analyze live polling results to enhance training effectiveness
        \item Collect, interpret, and present data from questionnaires in a visually compelling format to create reports
        \item Maintain SharePoint site to disseminate communications throughout the organization
    \end{itemize}
    \end{minipage}
}\
\end{tabularx}
