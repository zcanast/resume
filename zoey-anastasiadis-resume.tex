...
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep, leftmargin=2em, itemsep=3pt, label=\textendash]
        ...
        \item Collaborate with business teams to integrate data into Zenlytic, a data analyst AI chatbot, for streamlined business analysis processes
...
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep, leftmargin=2em, itemsep=3pt, label=\textendash]
        ...
        \item Implemented AWS Lambda functions to find and delete WorkSpaces not being used for more than 90 days, saving \$20,000 per year
...
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep, leftmargin=2em, itemsep=3pt, label=\textendash]
        ...
        \item Collaborated with IT stakeholders to design a data certification process, including surveys, training demos, and process mapping in Ardoq
...
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep, leftmargin=2em, itemsep=3pt, label=\textendash]
        ...
        \item Conducted data analysis of existing lessons learned data using Excel, Power BI, and Miro to identify trends and opportunities for improvements
