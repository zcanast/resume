...
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep, leftmargin=2em, itemsep=3pt, label=\textendash]
        ...
        \item Collaborate with IT stakeholders to design a data certification process, including surveys, training demos, and process mapping in Ardoq
        \item Develop a Python script to process 2,500 application names, generating app descriptions, vendor names, and URLs, improving data completion from 30\% to 63\%
        \item Implement a Python-based generative AI solution to retrieve and process 40,000 product manuals, extract metadata, and integrate it into Bynder, saving 650 productivity hours
        ...
        \item Strengthen leadership and presentation skills through regular stakeholder meetings
    \end{itemize}
    \end{minipage}
}\
\end{tabularx}
