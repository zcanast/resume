...
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep, leftmargin=2em, itemsep=3pt, label=\textendash]
        ...
        \item Conduct feedback sessions with stakeholders to agilely improve the semantic model, adding data context to enhance AI capabilities
...
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep, leftmargin=2em, itemsep=3pt, label=\textendash]
        ...
        \item Automated data collection in Power BI, saving around 20 hours per month and enabling leadership to identify cost saving opportunities
        ...
        \item Enhanced platform security by analyzing and updating user and role permissions in AWS Secrets Manager in preparation for audits
...
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep, leftmargin=2em, itemsep=3pt, label=\textendash]
        ...
        \item Partnered with IT stakeholders to design a data certification process through process mappings, survey development, and training demos
...
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep, leftmargin=2em, itemsep=3pt, label=\textendash]
        ...
        \item Established a biannual process for analyzing lessons learned data to generate actionable insights for process and project optimization
